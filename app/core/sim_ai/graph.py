...
async def evaluator_node(state: AgentState) -> dict:
    ...
    new_css_pro = get_css(pro_acc, state.get("css_pro", "HIGH"))
    new_css_con = get_css(con_acc, state.get("css_con", "HIGH"))
